...
public class KafkaClientTest extends AbstractKafkaClientTest {
  ...
  public void canPublishToKafka()
    ...
    KafkaClient responseKafkaClient = new KafkaClient(producerConfig);
  ...
  public void willThrowExceptionWhenUnableToPublish() throws Exception {
    ...
    final KafkaClient responseKafkaClient = new KafkaClient(producerConfig);
