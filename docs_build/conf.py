# -*- coding: utf-8 -*-
#
# Kafka Connect HTTP documentation build configuration file, created by
...
# ones.
extensions = ['sphinx.ext.ifconfig', 'sphinxcontrib.httpdomain','sphinxtogithub']
...
htmlhelp_basename = 'KafkaConnectHTTPDoc'
